...
git_url=https://github.com/easyploy/php.git
...
# SSH
echo -n "Testing ssh... "
docker_exec php touch /home/easyploy/.ssh/known_hosts
docker_exec php ssh easyploy@sshd cat /home/easyploy/.ssh/authorized_keys | grep -q admin@example.com
echo "OK"
